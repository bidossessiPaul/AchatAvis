...
('diversite_lieux', 'Diversité des Lieux', 'Ne postez pas uniquement des avis payés. Postez aussi sur votre boulangerie ou parc local.', '', 8, '["Postez au moins 2-3 avis \"gratuits\" pour chaque avis \"mission\"."]', '["Cela dilue vos activités commerciales dans un comportement normal."]'),
