    ...
    return (
        <DashboardLayout title="Gestion des Packs">
            <div className="admin-dashboard revamped">
                <div className="admin-main-card" style={{ background: 'transparent', boxShadow: 'none', padding: 0 }}>
                    <div className="admin-card-header" style={{ marginBottom: '2.5rem', padding: '0.5rem 0' }}>
                        <div>
                            <h2 className="card-title" style={{ fontSize: '1.75rem', fontWeight: 900 }}>Configuration des Offres</h2>
                            <p style={{ color: 'var(--gray-500)', fontSize: '0.95rem', marginTop: '6px' }}>
                                Gérez vos abonnements, tarifs et quotas de fiches pour les artisans.
                            </p>
                        </div>
                        <button className="admin-btn-primary" onClick={() => handleOpenModal()} style={{ borderRadius: '14px', padding: '0.8rem 1.5rem', fontWeight: 700 }}>
                            <Plus size={20} />
                            Nouveau Pack
                        </button>
                    </div>
